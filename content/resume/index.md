...
###### *March 2024 - Present*
 ...
 - overseeing an interdisciplinary research lab that operates across domains: AI, IOT, Cyber-Security, Data Center Operations and further miscellaneous knowledge bases
 - we explore whatever is necessary to craft solutions for problems spanning the vast cloud computing space
...
| Cloud Native GPU Operationalization                                                                                                                                                                | Horizontally scaled self hosted open source LLMs (OpenLLM, Kubernetes, nvidia-container-toolkit, VMWare ESXI) for serving LLMs to the engineering and support teams on heterogenous GPU clusters (from T4s to H100s)                        | (LLM:ML)Ops                                        |
