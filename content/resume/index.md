...
| Cloud Native LLM inference servers on heterogenous compute infrastructure                                                                                                                          | Horizontally scaled self hosted open source LLMs (OpenLLM, Kubernetes, nvidia-container-toolkit, VMWare ESXI) for serving LLMs (vLLMs) to the engineering and support teams on heterogenous compute infrastructure (Nvidia(T4s & H100s), AMD (MI300Xs and MI300A), X86 and ARM) | (LLM:ML)Ops                                   |
