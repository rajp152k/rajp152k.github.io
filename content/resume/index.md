...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| [fabric-gpt.el](https://github.com/rajp152k/fabric-gpt.el)                                                                                                                                         | An [Emacs Package](https://youtu.be/39OsH_OeWSA?si=xQLvotelXMECh9Lw) to employ crowd sourced prompts into the an emacs llm-client intuitively                                                                                                                                    | Software Engineering                          |
